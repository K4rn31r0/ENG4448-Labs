...
architecture behavior of Parking_tb is
    ...
    -- Procedimento auxiliar para aplicar um valor em a e b por 1 peri­odo de clock
    procedure set_ab(
    ...
    -- Sequencia completa de entrada: 00 -> 10 -> 11 -> 01 -> 00
    procedure enter_car(
        signal sa : out STD_LOGIC;
        signal sb : out STD_LOGIC
    ) is
    ...
    -- Sequencia completa de sai­da: 00 -> 01 -> 11 -> 10 -> 00
    procedure exit_car(
        signal sa : out STD_LOGIC;
        signal sb : out STD_LOGIC
    ) is
